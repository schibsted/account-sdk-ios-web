...
private func authenticatedBearerRequest(_ request: URLRequest, token: String) -> URLRequest {
...
private func encode(legacyClientId: String, legacyClientSecret: String) -> String {
