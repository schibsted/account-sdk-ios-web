...
1. To run an application on the simulator choose the ExampleWeb scheme and target your choices like an iPhone or iPad. Run the application with the play button or press `command + R`. 
...
1. You should be added as an owner to the library in the CocoaPods repository. Please ask the @UserAccess team, who can give you the correct rights.
