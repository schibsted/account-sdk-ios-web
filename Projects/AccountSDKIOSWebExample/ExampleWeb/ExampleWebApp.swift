...
struct ExampleWebApp: App {
    static let client: Client =  Client(configuration: ExampleWebApp.clientConfiguration, appIdentifierPrefix: "858G4SLVS5") //provide appIdentifierPrefix in order to enable Simplified Login feature
